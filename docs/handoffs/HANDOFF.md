...
- [x] **랜딩 시안** `docs/mockups/2026-09-21-landing.html` — **토스 결로 다시 지었다**(ollama 결 폐기, 왼쪽 고정 목차 삭제, JS 0). 히어로 48px 중앙 정렬 · 알약 CTA `#3182f6` · 카드 그리드 radius 20 · 섹션 간격 120px · 문구는 해요체(숫자·출처 문장은 그대로). 히어로 그림은 새 주간 장 스크린샷(`docs/mockups/assets/ledger.png`). 모바일 390px 가로 넘침 0 확인.
...
<!-- NEXT-ACTIONS -->
- [ ] 사용자에게 시안 두 장의 피드백을 받는다 — `xdg-open docs/mockups/2026-09-21-weekly-ledger.html` 과 `docs/mockups/2026-09-21-landing.html`. 미결로 남은 질문 셋: ①리스트 행 높이 72px 가 너무 헐거운지(한 화면 10~12줄) ②봉투 입력 줄을 맨 위 고정으로 두는 게 맞는지 ③랜딩 문구를 해요체로 바꾼 것이 이 사용자층(교회 재정 담당 장로)에 맞는지
